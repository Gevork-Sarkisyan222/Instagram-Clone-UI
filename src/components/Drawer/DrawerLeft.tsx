        ...
        {!isChatRoute && <div className="instagram-text">
          <div style={{ opacity: 1 }}>
            <Link
              ...
              role="link"
              tabIndex={0}>
              <div className="x9f619 xjbqb8w x78zum5 x168nmei x13lgxp2 x5pf9jr xo71vjh x1n2onr6 x1plvlek xryxfnj x1c4vz4f x2lah0s x1q0g3np xqjyukv x6s0dn4 x1oa3qoh x1nhvcw1">
                <div className="_aagx">
                  <svg
